...
- :func:`on_stage_instance_create(stage_instance) <niles.on_stage_instance_create>`
- :func:`on_stage_instance_delete(stage_instance) <niles.on_stage_instance_delete>`
- :func:`on_stage_instance_update(before, after) <niles.on_stage_instance_update>`
