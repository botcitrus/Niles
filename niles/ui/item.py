...
class WrappedComponent(ABC):
    ...
    - :class:`niles.ui.Button`
    - subtypes of :class:`niles.ui.BaseSelect` (:class:`niles.ui.ChannelSelect`, :class:`niles.ui.MentionableSelect`, :class:`niles.ui.RoleSelect`, :class:`niles.ui.StringSelect`, :class:`niles.ui.UserSelect`)
    - :class:`niles.ui.TextInput`
...
class Item(WrappedComponent, Generic[V_co]):
    ...
    This functionality mostly relates to :class:`niles.ui.View`.
