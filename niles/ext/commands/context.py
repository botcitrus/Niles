...
import niles.abc
import niles.utils
from niles import ApplicationCommandInteraction
from niles.message import Message

if TYPE_CHECKING:
    from typing_extensions import ParamSpec

    from niles.channel import DMChannel
    from niles.guild import Guild, GuildMessageable
    from niles.member import Member
    from niles.state import ConnectionState
    from niles.user import ClientUser, User
    from niles.voice_client import VoiceProtocol
...
class Context(niles.abc.Messageable, Generic[BotT]):
    ...
    async def _get_channel(self) -> niles.abc.Messageable:
        return self.channel
    ...
    def author(self) -> Union[User, Member]:
        """Union[:class:`~niles.User`, :class:`.Member`]:
    ...
    @niles.utils.copy_doc(Message.reply)
