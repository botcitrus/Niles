...
class TestBot(commands.Bot):
    ...
    async def _handle_error(
        self, ctx: Union[commands.Context, niles.AppCommandInter], error: Exception, prefix: str
    ) -> None:
    ...
    async def on_slash_command_error(
        self, inter: niles.AppCommandInter, error: commands.CommandError
    ) -> None:
...
print(f"niles: {niles.__version__}\n")
