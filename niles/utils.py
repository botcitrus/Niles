...
def oauth_url(
    ...
    *,
    ...
    permissions: :class:`~niles.Permissions`
        The permissions you're requesting. If not given then you won't be requesting any
        permissions.
    guild: :class:`~niles.abc.Snowflake`
...
def find(predicate: Callable[[T], Any], seq: Iterable[T]) -> Optional[T]:
    ...
    that meets the predicate. For example: ::
        ...
        member = niles.utils.find(lambda m: m.name == 'Mighty', channel.guild.members)

    would find the first :class:`~niles.Member` whose name is 'Mighty' and return it.
...
def get(iterable: Iterable[T], **attrs: Any) -> Optional[T]:
    ...
    .. code-block:: python3
        ...
        member = niles.utils.get(message.guild.members, name='Foo')

    Multiple attribute matching:

    .. code-block:: python3

        channel = niles.utils.get(guild.voice_channels, name='Foo', bitrate=64000)

    Nested attribute matching:

    .. code-block:: python3

        channel = niles.utils.get(client.get_all_channels(), guild__name='Cool', name='general')
...
def resolve_invite(
    ...
    """Resolves an invite from a :class:`~niles.Invite`, URL or code.

    Parameters
    ----------
    invite: Union[:class:`~niles.Invite`, :class:`str`]
...
def resolve_template(code: Union[Template, str]) -> str:
    """Resolves a template code from a :class:`~niles.Template`, URL or code.

    .. versionadded:: 1.4

    Parameters
    ----------
    code: Union[:class:`~niles.Template`, :class:`str`]
        The code.
...
def escape_mentions(text: str) -> str:
    ...
    .. note::
        ...
        within messages, refer to the :class:`~niles.AllowedMentions`
        class.
