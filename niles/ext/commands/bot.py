...
if TYPE_CHECKING:
    ...
    from niles.activity import BaseActivity
    from niles.client import GatewayParams
    from niles.enums import Status
    from niles.flags import Intents, MemberCacheFlags
    from niles.i18n import LocalizationProtocol
    from niles.mentions import AllowedMentions
...
class Bot(BotBase, InteractionBotBase, niles.Client):
    """Represents a discord bot.

    This class is a subclass of :class:`niles.Client` and as a result
    anything that you can do with a :class:`niles.Client` you can do with
    this bot.
    ...
    command_prefix
        ...
        as its first parameter and :class:`niles.Message` as its second
...
class AutoShardedBot(BotBase, InteractionBotBase, niles.AutoShardedClient):
    """Similar to :class:`.Bot`, except that it is inherited from
    :class:`niles.AutoShardedClient` instead.
    """
...
class InteractionBot(InteractionBotBase, niles.Client):
...
class AutoShardedInteractionBot(InteractionBotBase, niles.AutoShardedClient):
