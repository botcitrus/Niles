...
import niles
from niles import Localized
from niles.enums import Locale
...
class Localizations(commands.Cog):
    ...
    async def autocomp(
        self, inter: niles.AppCmdInter[commands.Bot], value: str
    ) -> "niles.app_commands.Choices":
    ...
    @commands.slash_command()
    async def localized_top_level(self, inter: niles.AppCmdInter[commands.Bot]) -> None:
        pass

    @localized_top_level.sub_command_group()
    async def second(self, inter: niles.AppCmdInter[commands.Bot]) -> None:
        pass
    ...
    async def cmd_msg(self, inter: niles.AppCmdInter[commands.Bot], msg: niles.Message) -> None:
