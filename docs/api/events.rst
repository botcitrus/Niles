...
method. Similarly you can remove a listener using the :meth:`Client.remove_listener` method. ::
    ...
    @client.listen()
    async def on_message(message: niles.Message):
        if message.author.bot:
            return
...
.. function:: on_application_command(interaction)
    ...
    .. warning::
        ...
        If you decide to override this event and are using :class:`~niles.ext.commands.Bot` or related types,
        make sure to call :func:`Bot.process_application_commands <niles.ext.commands.Bot.process_application_commands>`
...
.. function:: on_application_command_autocomplete(interaction)
    ...
    .. warning::
        If you decide to override this event and are using :class:`~niles.ext.commands.Bot` or related types,
        make sure to call :func:`Bot.process_app_command_autocompletion <niles.ext.commands.Bot.process_app_command_autocompletion>`
