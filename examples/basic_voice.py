...
class YTDLSource(niles.PCMVolumeTransformer):
    def __init__(self, source: niles.AudioSource, *, data: Dict[str, Any], volume: float = 0.5):
    ...
    async def from_url(
        ...
        return cls(niles.FFmpegPCMAudio(filename, options="-vn"), data=data)
...
class Music(commands.Cog):
    ...
    @commands.command()
    async def join(self, ctx, *, channel: niles.VoiceChannel):
    ...
    async def play(self, ctx, *, query: str):
        ...
        source = niles.PCMVolumeTransformer(niles.FFmpegPCMAudio(query))
