...
class Client:
    ...
    enable_gateway_error_handler: :class:`bool`
        Whether to enable the :func:`niles.on_gateway_error` event.
        Defaults to ``True``.
    ...
    def application_id(self) -> int:
        ...
        after :func:`~niles.on_connect` is called.
    ...
    def application_flags(self) -> ApplicationFlags:
        """:class:`~niles.ApplicationFlags`: The client's application flags.
    ...
    def _schedule_event(
        ...
        **kwargs: Any,
        ...
        # Schedules the task
        return asyncio.create_task(wrapped, name=f"niles: {event_name}")
    ...
    async def on_error(self, event_method: str, *args: Any, **kwargs: Any) -> None:
        ...
        Check :func:`~niles.on_error` for more details.
        """
    ...
    async def on_gateway_error(
        ...
        By default this prints to :data:`sys.stderr` however it could be
        overridden to have a different implementation.
        Check :func:`~niles.on_gateway_error` for more details.
    ...
    def allowed_mentions(self) -> Optional[AllowedMentions]:
        """Optional[:class:`~niles.AllowedMentions`]: The allowed mention configuration.
    ...
    def intents(self) -> Intents:
        """:class:`~niles.Intents`: The intents configured for this connection.
    ...
    def users(self) -> List[User]:
        """List[:class:`~niles.User`]: Returns a list of all the users the bot can see."""
    ...
    async def change_presence(
        ...
        *,
        ...
        .. code-block:: python3
            ...
            game = niles.Game("with the API")
            await client.change_presence(status=niles.Status.idle, activity=game)
    ...
    async def create_guild(
        ...
        *,
        ...
        TypeError
            The ``icon`` asset is a lottie sticker (see :func:`Sticker.read <niles.Sticker.read>`).
    ...
    async def fetch_user(self, user_id: int, /) -> User:
        ...
        Retrieves a :class:`~niles.User` based on their ID.
        You do not have to share any guilds with the user to get this information,
        however many operations do require that you do.

        .. note::

            This method is an API call. If you have :attr:`niles.Intents.members` and member cache enabled, consider :meth:`get_user` instead.
    ...
    async def create_dm(self, user: Snowflake) -> DMChannel:
        ...
        Parameters
        ----------
        user: :class:`~niles.abc.Snowflake`
    ...
    def add_view(self, view: View, *, message_id: Optional[int] = None) -> None:
        """Registers a :class:`~niles.ui.View` for persistent listening.
