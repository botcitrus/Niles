...
def avatar_converter(inter: niles.CommandInteraction, user: niles.User) -> str:
...
class SomeCustomClass:
    ...
    @classmethod
    async def from_option(cls, inter: niles.CommandInteraction, user: niles.User):
...
class OtherCustomClass:
    ...
    async def convert(cls, inter: niles.CommandInteraction, user: niles.User):
        return cls(user.name, user.discriminator)
