...
class ActionRow(Generic[UIComponentT]):
    ...
    :func:`niles.on_button_click` and :func:`niles.on_dropdown`, respectively. Alternatively,
    :func:`niles.on_message_interaction` can be used for either. For modals, the related event is
    :func:`niles.on_modal_submit`.
    ...
    *components: :class:`WrappedComponent`
    ...
    def add_button(
        ...
        *,
        ...
        To append a pre-existing :class:`~niles.ui.Button` use the
    ...
    def add_string_select(
        ...
        *,
        ...
        To append a pre-existing :class:`~niles.ui.StringSelect` use the
        :meth:`append_item` method instead.
        ...
        max_values: :class:`int`
            ...
            Defaults to 1 and must be between 1 and 25.
        options: Union[List[:class:`niles.SelectOption`], List[:class:`str`], Dict[:class:`str`, :class:`str`]]
    ...
    def add_user_select(
        ...
        *,
        ...
        To append a pre-existing :class:`~niles.ui.UserSelect` use the
        :meth:`append_item` method instead.
    ...
    def add_role_select(
        ...
        *,
        ...
        To append a pre-existing :class:`~niles.ui.RoleSelect` use the
        :meth:`append_item` method instead.
    ...
    def add_mentionable_select(
        ...
        *,
        ...
        To append a pre-existing :class:`~niles.ui.MentionableSelect` use the
        :meth:`append_item` method instead.
    ...
    def add_channel_select(
        ...
        *,
        ...
        To append a pre-existing :class:`~niles.ui.ChannelSelect` use the
        :meth:`append_item` method instead.
    ...
    def add_text_input(
        ...
        *,
        ...
        To append a pre-existing :class:`~niles.ui.TextInput` use the
        :meth:`append_item` method instead.
    ...
    def with_modal_components(cls) -> ActionRow[ModalUIComponent]:
        ...
        :class:`niles.ui.Modal`. Saves the need to import type specifiers to
    ...
    def with_message_components(cls) -> ActionRow[MessageUIComponent]:
        """Create an empty action row meant to store components compatible with
        :class:`niles.Message`. Saves the need to import type specifiers to
        typehint empty action rows.
