...
class Intents(BaseFlags):
    ...
    def message_content(self):
        ...
        This applies to the following fields on :class:`~niles.Message` instances:

        - :attr:`~niles.Message.content`
        - :attr:`~niles.Message.embeds`
        - :attr:`~niles.Message.attachments`
        - :attr:`~niles.Message.components`
        ...
        - Messages received from an interaction payload, these will typically be attributes on :class:`~niles.MessageInteraction` instances.
