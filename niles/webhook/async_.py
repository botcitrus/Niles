    ...
    async def send(
        ...
        *,
        ...
        allowed_mentions: :class:`AllowedMentions`
            ...
            passed, then the object is merged with :attr:`Client.allowed_mentions <niles.Client.allowed_mentions>`, if applicable.
        ...
        thread: :class:`~niles.abc.Snowflake`
