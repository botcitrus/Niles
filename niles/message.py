...
class MessageReference:
    """Represents a reference to a :class:`~niles.Message`.
    ...
    def from_message(cls, message: Message, *, fail_if_not_exists: bool = True) -> Self:
        """Creates a :class:`MessageReference` from an existing :class:`~niles.Message`.
    ...
    def cached_message(self) -> Optional[Message]:
        """Optional[:class:`~niles.Message`]: The cached message, if found in the internal message cache."""
...
class Message(Hashable):
    ...
    reference: Optional[:class:`~niles.MessageReference`]
    ...
    interaction: Optional[:class:`~niles.InteractionReference`]
    ...
    async def edit(
        ...
        *,
        ...
        allowed_mentions: Optional[:class:`~niles.AllowedMentions`]
        ...
        view: Optional[:class:`~niles.ui.View`]
    ...
    async def create_thread(
        ...
        *,
        ...
        You must have :attr:`~niles.Permissions.create_public_threads` in order to
    ...
    async def reply(
        ...
        ----------
        fail_if_not_exists: :class:`bool`
            Whether replying using the message reference should raise :exc:`~niles.HTTPException`
            if the message no longer exists or Discord could not fetch the message.
    ...
    def to_reference(self, *, fail_if_not_exists: bool = True) -> MessageReference:
        """Creates a :class:`~niles.MessageReference` from the current message.
...
class PartialMessage(Hashable):
    ...
    async def edit(
        ...
        *,
        ...
        .. versionchanged:: 2.1
            :class:`niles.Message` is always returned.
