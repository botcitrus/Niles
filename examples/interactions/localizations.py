...
import niles
from niles import Localized, OptionChoice
from niles.ext import commands

bot = commands.Bot(command_prefix=commands.when_mentioned)


# For more details, see https://docs.niles.dev/en/stable/ext/commands/slash_commands.html#localizations
...
async def game_autocomp(inter: niles.CommandInteraction, string: str):
