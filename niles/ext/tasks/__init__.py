...
import niles
from niles.backoff import ExponentialBackoff
...
class SleepHandle:
    ...
    def __init__(self, dt: datetime.datetime, *, loop: asyncio.AbstractEventLoop) -> None:
        ...
        relative_delta = niles.utils.compute_timedelta(dt)
...
class Loop(Generic[LF]):
    ...
    def __init__(
        ...
        *,
        ...
        self._valid_exception = (
            OSError,
            niles.GatewayNotFound,
            niles.ConnectionClosed,
            aiohttp.ClientError,
    ...
    def add_exception_type(self, *exceptions: Type[BaseException]) -> None:
        ...
        :meth:`niles.Client.connect`\\, which includes a lot of internet disconnection
        errors.
    ...
    def before_loop(self, coro: FT) -> FT:
        ...
        such as :meth:`niles.Client.wait_until_ready`.
...
def loop(
    ...
    **kwargs: Any,
    ...
    reconnect: :class:`bool`
        ...
        one used in :meth:`niles.Client.connect`.
