...
def test_event(client_or_bot: niles.Client) -> None:
...
def test_wait_for(client_or_bot: niles.Client, event) -> None:
...
def test_addremove_listener(client_or_bot: niles.Client, event) -> None:
...
def test_addremove_listener__implicit(client_or_bot: niles.Client) -> None:
...
def test_listen(client_or_bot: niles.Client, event) -> None:
...
def test_listen__implicit(client_or_bot: niles.Client) -> None:
