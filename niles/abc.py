...
class User(Snowflake, Protocol):
    ...
    - :class:`~niles.User`
    - :class:`~niles.ClientUser`
    - :class:`~niles.Member`

    This ABC must also implement :class:`~niles.abc.Snowflake`.
    ...
    def avatar(self) -> Optional[Asset]:
        """Optional[:class:`~niles.Asset`]: Returns an :class:`~niles.Asset` for
...
class PrivateChannel(Snowflake, Protocol):
    ...
    - :class:`~niles.DMChannel`
    - :class:`~niles.GroupChannel`

    This ABC must also implement :class:`~niles.abc.Snowflake`.

    Attributes
    ----------
    me: :class:`~niles.ClientUser`
...
class GuildChannel(ABC):
    ...
    def overwrites_for(self, obj: Union[Role, User]) -> PermissionOverwrite:
        ...
        Returns
        -------
        :class:`~niles.PermissionOverwrite`
    ...
    def overwrites(self) -> Dict[Union[Role, Member], PermissionOverwrite]:
        ...
        can be either a :class:`~niles.Role` or a :class:`~niles.Member` and the value is the
        overwrite as a :class:`~niles.PermissionOverwrite`.

        Returns
        -------
        Dict[Union[:class:`~niles.Role`, :class:`~niles.Member`], :class:`~niles.PermissionOverwrite`]
        ...
        for ow in self._overwrites:
            ...
            # i.e. adding niles.Object to the list of it
    ...
    def category(self) -> Optional[CategoryChannel]:
        """Optional[:class:`~niles.CategoryChannel`]: The category this channel belongs to.
    ...
    def permissions_for(
        ...
        *,
        ...
        """Handles permission resolution for the :class:`~niles.Member`
        or :class:`~niles.Role`.
        ...
        If a :class:`~niles.Role` is passed, then it checks the permissions
        ...
        Parameters
        ----------
        obj: Union[:class:`~niles.Member`, :class:`~niles.Role`]
        ...
        ignore_timeout: :class:`bool`
            ...
            .. note::
                ...
                This only applies to :class:`~niles.Member` objects.
        ...
        ------
        TypeError
            ``ignore_timeout`` is only supported for :class:`~niles.Member` objects.

        Returns
        -------
        :class:`~niles.Permissions`
        ...
        if ignore_timeout is not MISSING and isinstance(obj, Role):
            raise TypeError("ignore_timeout is only supported for niles.Member objects")
    ...
    async def set_permissions(
        ...
        **permissions,
        ...
        Using :class:`.PermissionOverwrite` ::
            ...
            overwrite = niles.PermissionOverwrite()
...
class Messageable:
    ...
    - :class:`~niles.TextChannel`
    - :class:`~niles.DMChannel`
    - :class:`~niles.GroupChannel`
    - :class:`~niles.User`
    - :class:`~niles.Member`
    - :class:`~niles.Thread`
    - :class:`~niles.VoiceChannel`
    - :class:`~niles.StageChannel`
    - :class:`~niles.ext.commands.Context`
    - :class:`~niles.PartialMessageable`
    """
