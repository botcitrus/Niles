...
class Guild(Hashable):
    ...
    features: List[:class:`str`]
        ...
        - ``VANITY_URL``: Guild can have a vanity invite URL (e.g. discord.gg/niles).
    ...
    async def create_text_channel(
        ...
        *,
        ...
        .. code-block:: python3
            ...
            overwrites = {
                guild.default_role: niles.PermissionOverwrite(view_channel=False),
                guild.me: niles.PermissionOverwrite(view_channel=True)
            }
    ...
    async def edit_welcome_screen(
        ...
        *,
        ...
        TypeError
            ``channels`` is not a list of :class:`~niles.WelcomeScreenChannel` instances
    ...
    def bans(
        ...
        *,
        ...
        """Returns an :class:`~niles.AsyncIterator` that enables receiving the destination's bans.

        You must have the :attr:`~Permissions.ban_members` permission to get this information.

        .. versionchanged:: 2.5
            Due to a breaking change in Discord's API, this now returns an :class:`~niles.AsyncIterator` instead of a :class:`list`.
        ...
        limit: Optional[:class:`int`]
            ...
            Defaults to 1000.
        before: Optional[:class:`~niles.abc.Snowflake`]
            Retrieve bans before this user.
        after: Optional[:class:`~niles.abc.Snowflake`]
    ...
    def audit_logs(
        ...
        *,
        ...
        Getting entries for a specific action: ::
            ...
            async for entry in guild.audit_logs(action=niles.AuditLogAction.ban):
    ...
    async def edit_widget(
        ...
        *,
        ...
        channel: Optional[:class:`~niles.abc.Snowflake`]
...
class GuildBuilder:
    ...
    async def create(self) -> Guild:
        ...
        TypeError
            The :attr:`.icon` asset is a lottie sticker (see :func:`Sticker.read <niles.Sticker.read>`).
