...
class SlashCommands(commands.Cog):
    ...
    async def hello(self, inter: niles.CommandInteraction[commands.Bot]) -> None:
        await inter.response.send_message("Hello world!")

    @commands.slash_command()
    async def auto(self, inter: niles.CommandInteraction[commands.Bot], mood: str) -> None:
    ...
    async def test_autocomp(self, inter: niles.CommandInteraction[commands.Bot], string: str):
        return ["XD", ":D", ":)", ":|", ":("]

    @commands.slash_command()
    async def alt_auto(
        self,
        inter: niles.AppCmdInter[commands.Bot],
    ...
    async def guild_only(
        self, inter: niles.GuildCommandInteraction[commands.Bot], option: Optional[str] = None
    ) -> None:
    ...
    async def ranges(
        self,
        inter: niles.CommandInteraction[commands.Bot],
    ...
    async def largenumber(
        self, inter: niles.CommandInteraction[commands.Bot], largenum: commands.LargeInt
    ) -> None:
