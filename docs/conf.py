...
# niles documentation build configuration file, created by
...
github_repo = "https://github.com/botcitrus/niles"
...
.. |components_type| replace:: Union[:class:`niles.ui.ActionRow`, :class:`niles.ui.WrappedComponent`, List[Union[:class:`niles.ui.ActionRow`, :class:`niles.ui.WrappedComponent`, List[:class:`niles.ui.WrappedComponent`]]]]
...
project = "niles"
copyright = "2015-2021, Rapptz, 2021-present, Niles Development"
...
version = ""
with open("../niles/__init__.py") as f:
...
_spec = importlib.util.find_spec("niles")
...
def linkcode_resolve(domain: str, info: Dict[str, Any]) -> Optional[str]:
    ...
    return f"{github_repo}/blob/{git_ref}/niles/{path}"
...
html_context = {
    "discord_invite": "https://discord.gg/niles",
    "discord_extensions": [
        ("niles.ext.commands", "ext/commands"),
        ("niles.ext.tasks", "ext/tasks"),
    ],
}

resource_links = {
    "niles": "https://discord.gg/niles",
...
latex_documents = [
    ("index", "niles.tex", "niles Documentation", "Rapptz", "manual"),
]
...
man_pages = [("index", "niles", "niles Documentation", ["Rapptz"], 1)]
...
def setup(app: Sphinx) -> None:
    if app.config.language == "ja":
        ...
        app.config.html_context["discord_invite"] = "https://discord.gg/niles"
        app.config.resource_links["niles"] = "https://discord.gg/niles"

    # HACK: avoid deprecation warnings caused by sphinx always iterating over all class attributes
    import niles

    del niles.Embed.Empty  # type: ignore
