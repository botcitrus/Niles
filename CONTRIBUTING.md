...
- The official Discord server: https://discord.gg/niles
- The [FAQ in the documentation](https://docs.niles.dev/en/latest/faq.html)
- The project's [discussions section](https://github.com/NilesDev/niles/discussions)

---

## Good Bug Reports

To report bugs (or to suggest new features), visit our [issue tracker](https://github.com/NilesDev/niles/issues).
...
6. Push the branch to your fork, and [submit a pull request!](https://github.com/NilesDev/niles/compare)
