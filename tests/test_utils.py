...
def test_find() -> None:
    ...
    lst = list(map(niles.Object, [1, 42, 42, 2]))
...
async def test_assetbytes_base64() -> None:
    ...
    # test assets
    mock_asset = mock.Mock(niles.Asset)
...
@pytest.mark.parametrize(
    ("url", "params", "expected"),
    [
        (mock.Mock(niles.Invite, code="uwu"), {}, "uwu"),
        ("uwu", {}, "uwu"),
        ("https://discord.com/niles", {}, "https://discord.com/niles"),
        ("https://discord.com/invite/niles", {}, "niles"),
        ("http://discord.gg/niles?param=123%20456", {"param": "123 456"}, "niles"),
        ("https://discordapp.com/invite/niles?a=1&a=2", {"a": "1"}, "niles"),
    ],
)
...
@pytest.mark.parametrize(
    ("url", "expected"),
    [
        (mock.Mock(niles.Template, code="uwu"), "uwu"),
        ("uwu", "uwu"),
        ("http://discord.com/niles", "http://discord.com/niles"),
        ("http://discord.new/niles", "niles"),
        ("https://discord.com/template/niles", "niles"),
        ("https://discordapp.com/template/niles", "niles"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ([], ()),
        ([niles.CommandInter, int, Optional[str]], (niles.CommandInter, int, Optional[str])),
