...
This is the documentation for niles, a library for Python to aid
in creating applications that utilise the Discord API.

Prerequisites
-------------

niles works with Python 3.8 or higher. Support for earlier versions of Python
...
To get voice support, you should use ``niles[voice]`` instead of ``niles``, e.g. ::

    python3 -m pip install -U niles[voice]
...
niles revolves around the concept of :ref:`events <disnake_api_events>`.
