...
class HelpCommand:
    ...
    def __init__(self, **options) -> None:
        ...
        self.context: Context = niles.utils.MISSING
    ...
    def get_max_size(self, commands):
        ...
        """
        as_lengths = (niles.utils._string_width(c.name) for c in commands)
        return max(as_lengths, default=0)

    def get_destination(self):
        """Returns the :class:`~niles.abc.Messageable` where the help command will be output.
    ...
    async def command_callback(self, ctx, *, command=None):
        ...
        maybe_coro = niles.utils.maybe_coroutine
...
class DefaultHelpCommand(HelpCommand):
    ...
    def add_indented_commands(self, commands, *, heading, max_size: Optional[int] = None) -> None:
        ...
        get_width = niles.utils._string_width
