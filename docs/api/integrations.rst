...
- :func:`on_guild_integrations_update(guild) <niles.on_guild_integrations_update>`
- :func:`on_integration_create(integration) <niles.on_integration_create>`
- :func:`on_integration_update(integration) <niles.on_integration_update>`
- :func:`on_raw_integration_delete(payload) <niles.on_raw_integration_delete>`
