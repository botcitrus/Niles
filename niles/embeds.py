...
class Embed:
    ...
    def colour(self, value: Optional[Union[int, Colour]]) -> None:
        if isinstance(value, int):
            ...
            raise TypeError(
                f"Expected niles.Colour, int, or None but received {type(value).__name__} instead."
            )
    ...
    def set_image(self, url: Optional[Any] = MISSING, *, file: File = MISSING) -> Self:
        ...
        .. warning::
            Passing a :class:`niles.File` object will make the embed not
            reusable.
