...
class View:
    ...
    Alternatively, components can be handled with :class:`niles.ui.ActionRow`\\s and event
    listeners for a more low-level approach. Relevant events are :func:`niles.on_button_click`,
    :func:`niles.on_dropdown`, and the more generic :func:`niles.on_message_interaction`.
    ...
    def from_message(cls, message: Message, /, *, timeout: Optional[float] = 180.0) -> View:
        ...
        and separate types from those in the ``niles.ui`` namespace.
    ...
    def _dispatch_timeout(self) -> None:
        ...
        asyncio.create_task(self.on_timeout(), name=f"niles-ui-view-timeout-{self.id}")
    ...
    def _dispatch_item(self, item: Item, interaction: MessageInteraction) -> None:
        ...
        asyncio.create_task(
            self._scheduled_task(item, interaction), name=f"niles-ui-view-dispatch-{self.id}"
        )
