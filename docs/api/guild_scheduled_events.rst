...
- :func:`on_guild_scheduled_event_create(event) <niles.on_guild_scheduled_event_create>`
- :func:`on_guild_scheduled_event_delete(event) <niles.on_guild_scheduled_event_delete>`
- :func:`on_guild_scheduled_event_update(before, after) <niles.on_guild_scheduled_event_update>`
- :func:`on_guild_scheduled_event_subscribe(event, user) <niles.on_guild_scheduled_event_subscribe>`
- :func:`on_guild_scheduled_event_unsubscribe(event, user) <niles.on_guild_scheduled_event_unsubscribe>`
- :func:`on_raw_guild_scheduled_event_subscribe(payload) <niles.on_raw_guild_scheduled_event_subscribe>`
- :func:`on_raw_guild_scheduled_event_unsubscribe(payload) <niles.on_raw_guild_scheduled_event_unsubscribe>`
