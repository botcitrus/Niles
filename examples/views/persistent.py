...
class PersistentView(niles.ui.View):
    def __init__(self):
        super().__init__(timeout=None)

    @niles.ui.button(
        label="Green", style=niles.ButtonStyle.green, custom_id="persistent_example:green"
    )
    async def green(self, button: niles.ui.Button, inter: niles.MessageInteraction):
        await inter.response.send_message("This is green.", ephemeral=True)

    @niles.ui.button(
        label="Red", style=niles.ButtonStyle.red, custom_id="persistent_example:red"
    )
    async def red(self, button: niles.ui.Button, inter: niles.MessageInteraction):
        await inter.response.send_message("This is red.", ephemeral=True)

    @niles.ui.button(
        label="Grey", style=niles.ButtonStyle.grey, custom_id="persistent_example:grey"
    )
    async def grey(self, button: niles.ui.Button, inter: niles.MessageInteraction):
