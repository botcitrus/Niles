...
class Button(Component):
    ...
    .. note::
        ...
        The user constructible and usable type to create a button is :class:`niles.ui.Button`,
        not this one.
...
class BaseSelectMenu(Component):
    ...
    - :class:`~niles.StringSelectMenu`
    - :class:`~niles.UserSelectMenu`
    - :class:`~niles.RoleSelectMenu`
    - :class:`~niles.MentionableSelectMenu`
    - :class:`~niles.ChannelSelectMenu`
...
class StringSelectMenu(BaseSelectMenu):
    ...
    .. note::
        ...
        string select menu is :class:`niles.ui.StringSelect`.
...
class UserSelectMenu(BaseSelectMenu):
    ...
    .. note::
        The user constructible and usable type to create a
        user select menu is :class:`niles.ui.UserSelect`.
...
class RoleSelectMenu(BaseSelectMenu):
    ...
    .. note::
        The user constructible and usable type to create a
        role select menu is :class:`niles.ui.RoleSelect`.
...
class MentionableSelectMenu(BaseSelectMenu):
    ...
    .. note::
        The user constructible and usable type to create a
        mentionable select menu is :class:`niles.ui.MentionableSelect`.
...
class ChannelSelectMenu(BaseSelectMenu):
    ...
    .. note::
        The user constructible and usable type to create a
        channel select menu is :class:`niles.ui.ChannelSelect`.
...
class TextInput(Component):
    ...
    .. note::
        ...
        :class:`niles.ui.TextInput`, not this one.
