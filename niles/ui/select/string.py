...
class StringSelect(BaseSelect[StringSelectMenu, str, V_co]):
    ...
    def options(self) -> List[SelectOption]:
        """List[:class:`niles.SelectOption`]: A list of options that can be selected in this select menu."""
    ...
    def append_option(self, option: SelectOption) -> None:
        ...
        Parameters
        ----------
        option: :class:`niles.SelectOption`
...
def string_select(
    ...
    the :class:`niles.ui.View`, the :class:`niles.ui.StringSelect` that was
    interacted with, and the :class:`niles.MessageInteraction`.
