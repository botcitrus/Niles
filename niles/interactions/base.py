...
class Interaction(Generic[ClientT]):
    ...
    def bot(self) -> ClientT:
        """:class:`~niles.ext.commands.Bot`: An alias for :attr:`.client`."""
        return self.client
    ...
    async def send(
        ...
        *,
        ...
        allowed_mentions: :class:`AllowedMentions`
            ...
            passed, then the object is merged with :attr:`Client.allowed_mentions <niles.Client.allowed_mentions>`.
            The merging behaviour only overrides attributes that have been explicitly passed
            to the object, otherwise it uses the attributes set in :attr:`Client.allowed_mentions <niles.Client.allowed_mentions>`.
            If no object is passed at all then the defaults given by :attr:`Client.allowed_mentions <niles.Client.allowed_mentions>`
            are used instead.
        tts: :class:`bool`
...
class InteractionMessage(Message):
    ...
    This inherits from :class:`niles.Message` with changes to
