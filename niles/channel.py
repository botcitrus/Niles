...
class TextChannel(niles.abc.Messageable, niles.abc.GuildChannel, Hashable):
    ...
    @utils.copy_doc(niles.abc.GuildChannel.permissions_for)
    def permissions_for(
        self,
    ...
    async def create_thread(
        ...
        *,
        ...
        To create a public thread, you must have :attr:`~niles.Permissions.create_public_threads` permission.
        For a private thread, :attr:`~niles.Permissions.create_private_threads` permission is needed instead.
    ...
    def archived_threads(
        ...
        *,
        ...
        """Returns an :class:`~niles.AsyncIterator` that iterates over all archived threads in the channel.
...
class VocalGuildChannel(niles.abc.Connectable, niles.abc.GuildChannel, Hashable):
    __slots__ = (
        "name",
        "id",
        "guild",
...
class VoiceChannel(niles.abc.Messageable, VocalGuildChannel):
...
class StageChannel(niles.abc.Messageable, VocalGuildChannel):
...
class CategoryChannel(niles.abc.GuildChannel, Hashable):
    ...
    @utils.copy_doc(niles.abc.GuildChannel.move)
...
class ForumChannel(niles.abc.GuildChannel, Hashable):
    ...
    @utils.copy_doc(niles.abc.Messageable.typing)
...
class DMChannel(niles.abc.Messageable, Hashable):
...
class GroupChannel(niles.abc.Messageable, Hashable):
...
class PartialMessageable(niles.abc.Messageable, Hashable):
...
def _channel_type_factory(
    cls: Union[Type[niles.abc.GuildChannel], Type[Thread]]
) -> List[ChannelType]:
    return {
        niles.abc.GuildChannel: list(ChannelType.__members__.values()),
        VocalGuildChannel: [ChannelType.voice, ChannelType.stage_voice],
        niles.abc.PrivateChannel: [ChannelType.private, ChannelType.group],
