...
from niles.errors import ClientException, DiscordException
from niles.utils import humanize_list

if TYPE_CHECKING:
    from inspect import Parameter

    from niles.abc import GuildChannel
    from niles.threads import Thread
    from niles.types.snowflake import Snowflake, SnowflakeList
...
class CommandError(DiscordException):
    ...
    This inherits from :exc:`niles.DiscordException`.
...
class CheckAnyFailure(CheckFailure):
    ...
    checks: List[Callable[[Union[:class:`Context`, :class:`niles.ApplicationCommandInteraction`]], :class:`bool`]]
...
class CommandRegistrationError(ClientException):
    ...
    This inherits from :exc:`niles.ClientException`
