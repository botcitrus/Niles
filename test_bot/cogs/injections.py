...
def injected(user: niles.User, channel: niles.TextChannel):
...
class PrefixConverter:
    ...
    def __call__(self, inter: niles.CommandInteraction[commands.Bot], a: str = "init"):
...
class HopeToGod:
    ...
    async def convert(cls, inter: niles.CommandInteraction[commands.Bot], user: niles.User):
...
async def perhaps_this_is_it(
    disc_channel: niles.TextChannel = commands.Param(lambda i: i.channel),
