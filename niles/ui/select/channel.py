...
class ChannelSelect(BaseSelect[ChannelSelectMenu, "InteractionChannel", V_co]):
    ...
    def channel_types(self) -> Optional[List[ChannelType]]:
        """Optional[List[:class:`niles.ChannelType`]]: A list of channel types that can be selected in this select menu."""
...
def channel_select(
    ...
    the :class:`niles.ui.View`, the :class:`niles.ui.ChannelSelect` that was
