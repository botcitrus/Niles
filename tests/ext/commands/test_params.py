...
import niles
from niles import Member, Role, User
from niles.ext import commands

OptionType = niles.OptionType
...
class TestParamInfo:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (niles.abc.User, OptionType.user, [User, Member]),
            ...
            (niles.abc.Snowflake, OptionType.mentionable, [User, Member, Role]),
        ],
    )
    @pytest.mark.asyncio
...
class TestRangeStringParam:
    ...
    def test_optional(self, annotation_str) -> None:
        annotation = niles.utils.resolve_annotation(annotation_str, globals(), None, None)
...
class TestIsolateSelf:
    ...
    def test_function_inter(self) -> None:
        def func(inter: niles.ApplicationCommandInteraction, a: int) -> None:
            ...
    ...
    def test_unbound_method(self) -> None:
        class Cog(commands.Cog):
            def func(self, inter: niles.ApplicationCommandInteraction, a: int) -> None:
                ...
    ...
    def test_generic(self) -> None:
        def func(inter: niles.ApplicationCommandInteraction[commands.Bot], a: int) -> None:
            ...
    ...
    def test_inter_union(self) -> None:
        def func(
            inter: Union[commands.Context, niles.ApplicationCommandInteraction[commands.Bot]],
            a: int,
        ) -> None:
            ...
