...
import niles
from niles.app_commands import ApplicationCommand, Option
from niles.custom_warnings import SyncWarning
from niles.enums import ApplicationCommandType
from niles.utils import warn_deprecated
...
if TYPE_CHECKING:
    ...
    from niles.i18n import LocalizedOptional
    from niles.interactions import (
        ApplicationCommandInteraction,
        MessageCommandInteraction,
        UserCommandInteraction,
    )
    from niles.permissions import Permissions
...
MISSING: Any = niles.utils.MISSING
...
class InteractionBotBase(CommonBotBase):
    ...
    @niles.utils.copy_doc(niles.Client.login)
    ...
    def add_slash_command(self, slash_command: InvokableSlashCommand) -> None:
        ...
        """
        if not isinstance(self, niles.Client):
            raise NotImplementedError("This method is only usable in niles.Client subclasses")
    ...
    def slash_command(
        ...
        **kwargs,
        ...
        """A shortcut decorator that invokes :func:`~niles.ext.commands.slash_command` and adds it to
    ...
    def user_command(
        ...
        **kwargs,
        ...
        """A shortcut decorator that invokes :func:`~niles.ext.commands.user_command` and adds it to
        the internal command list.
    ...
    def message_command(
        ...
        **kwargs,
        ...
        """A shortcut decorator that invokes :func:`~niles.ext.commands.message_command` and adds it to
        the internal command list.
    ...
    async def _cache_application_commands(self) -> None:
        ...
        except (niles.HTTPException, TypeError):
            pass
    ...
    async def _prepare_application_commands(self) -> None:
        if not isinstance(self, niles.Client):
            raise NotImplementedError("Command sync is only possible in niles.Client subclasses")
    ...
    def _schedule_app_command_preparation(self) -> None:
        ...
        self.loop.create_task(
            self._prepare_application_commands(), name="niles: app_command_preparation"
        )
    ...
    def _schedule_delayed_command_sync(self) -> None:
        ...
        self.loop.create_task(self._delayed_command_sync(), name="niles: delayed_command_sync")
    ...
    async def application_command_can_run(
        ...
        return await niles.utils.async_all(f(inter) for f in checks)
    ...
    async def process_app_command_autocompletion(
        ...
        Parameters
        ----------
        inter: :class:`niles.ApplicationCommandInteraction`
    ...
    async def process_application_commands(
        ...
        Parameters
        ----------
        interaction: :class:`niles.ApplicationCommandInteraction`
        ...
        if (
            ...
            try:
                ...
                message += (
                    ...
                    "https://docs.niles.dev/page/ext/commands/additional_info.html#unknown-commands."
                )
                await interaction.response.send_message(
                    message,
                    ephemeral=True,
                )
            except (niles.HTTPException, niles.InteractionTimedOut):
                pass
            return
